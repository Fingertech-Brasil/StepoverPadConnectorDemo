var signSocket = ( function($) {
	...
	pub.signSocketStartSigning = function( x, y, width, height, resolution, page, withHashDialog, signSession, signatureTimeout, callback )
	{
		send( 'startSigning', { 'x': x, 'y':  y, 'width': width, 'height': height, 'resolution': resolution, 'page': page, 'withHashDialog' : withHashDialog, 'signSession' : signSession, 'signatureTimeout' : signatureTimeout }, callback );
	};
